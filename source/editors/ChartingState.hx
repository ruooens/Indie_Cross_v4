...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Last Reel Event', 'Drains the player health to almost 0.']
	];
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var gfDropDown = new FlxUIDropDownMenuCustom(player1DropDown.x, player1DropDown.y + 40, FlxUIDropDownMenuCustom.makeStrIdLabelArray(characters, true), function(character:String)
		{
		...
		var player2DropDown = new FlxUIDropDownMenuCustom(player1DropDown.x, gfDropDown.y + 40, FlxUIDropDownMenuCustom.makeStrIdLabelArray(characters, true), function(character:String)
		{
		...
		tab_group_song.add(new FlxText(gfDropDown.x, gfDropDown.y - 15, 0, 'Girlfriend:'));
